      ...
      <Card className="shadow-sm">
        ...
        <CardHeader className="text-white" style={{ background: 'linear-gradient(135deg, #0d6efd 0%, #0a58ca 100%)' }}>
          <Row className="align-items-center">
            <Col>
              <h1 className="h3 mb-1">FICHE DE VISITE DE CHANTIER</h1>
              <p className="mb-0 small">Structure : ARES | Date de la visite : 19 oct. 23 | Visite N°: 02</p>
            </Col>
            <Col xs="auto">
          ...
          <Container>
            <Row className="text-center">
              ...
              <Col>
                ...
                <p className="text-primary fw-medium mb-0">LOM-ET-DJEREM</p>
              </Col>
              <Col>
                <p className="fw-bold mb-1">COMMUNE</p>
                <p className="text-primary fw-medium mb-0">DIANG</p>
              </Col>
            </Row>
          </Container>
        </div>
            ...
            <CardBody>
              <Row>
                <Col md={6}>
                  ...
                  <p className="fw-bold">Convention : <span className="fw-normal">Oui N° : 049/PCCM/FEICOM/ DG/CA J/DC C/2023</span></p>
              ...
              <Row className="my-3">
                <Col md={6}>
                  <p className="fw-bold">Montant : <span className="text-success fw-bold">108 420 000 FCFA TTC</span></p>
                </Col>
                <Col md={6}>
              ...
              <Row>
                ...
                <Col md={4}>
                  <p className="fw-bold">Mise en Œuvre du financement : <span className="fw-normal">……%</span></p>
                </Col>
                <Col md={4}>
                  <p className="fw-bold">Durée de la Convention : <span className="fw-normal">An(s)</span></p>
                </Col>
              </Row>
            </CardBody>
          </Card>
              ...
              <Row>
                ...
                <Col md={6}>
                  ...
                  <div className="ps-3 border-start border-2 border-primary">
                    <p className="fw-bold mb-1">Contrat Nom : <span className="fw-normal">TROPICAL FOREST MANAGEMENT SARL</span></p>
                    <p className="fw-bold mb-1">Lot : <span className="fw-normal">Pas de Lot</span></p>
                    <p className="fw-bold mb-1">BP : <span className="fw-normal">14734 YAOUNDE</span></p>
                    <p className="fw-bold mb-1">Tel : <span className="fw-normal">678648009</span></p>
                    <p className="fw-bold mb-1">Montant : <span className="text-success">108 400 000 FCFCA TTC</span></p>
                    ...
                    <p className="fw-bold mb-1">Délais : <span className="fw-normal">07 Mois</span></p>
                  </div>
                ...
                <Col md={6}>
                  ...
                  <div className="ps-3 border-start border-2 border-primary">
                    ...
                    <p className="fw-bold mb-1">Avenant : <span className="fw-normal">Entrée N°</span></p>
                    <p className="fw-bold mb-1">Os de Démarrage : <span className="fw-normal">Entrez Date</span></p>
                    <p className="fw-bold mb-1">Délais : <span className="fw-normal">…… Mois</span></p>
                  </div>
              ...
              <Row>
                <Col md={6}>
                  ...
                  <p className="text-justify">
                    Sur le site, accompagné du Maire, nous avons constaté que l'entreprise s'est mobilisée et les travaux sont en cours, rendus à la fin du chainage haut pour le bloc de T3 et à la fin des travaux de fondation pour les deux blocs de T2. En termes de mobilisation, 19 personnels présents à savoir 01 conducteur des travaux, 03 chefs chantier, 06 maçons, 02 ferrailleurs, 07 manœuvres, s'activaient aux élevations des murs de soubassement restants. S'agissant des matériels et matériaux, deux tas de sable, un tas de gravier et une vingtaine de sacs de ciment sont disponibles sur le chantier. Le taux d'avancement est de 24,3% pour une consommation des délais de 52,38%, soit un écart négatif de 28,08% à rattraper absolument. La cadence actuelle des travaux est satisfaisante mais à maintenir pour pouvoir livrer l'ouvrage dans les délais contractuels. Cependant, il a été relevé l'absence de tamis pour sable et d'EPI chez certains ouvriers. Par ailleurs, l'entreprise n'a pas transmis à date le projet d'exécution des ouvrages.
                  </p>
                </Col>
                <Col md={6}>
                  <h6 className="fw-bold text-primary mb-2">Recommandations</h6>
                  <p className="fw-bold">À l'endroit de l'entreprise, il a été recommandé de :</p>
                  ...
                  <p className="fw-bold mt-3">À l'endroit du Maître d'ouvrage, il a été recommandé de :</p>
                  <ul className="ps-3">
                    <li>Transmettre tous les documents administratifs liés au projet (marché, OS de démarrage, …)</li>
                  </ul>
                </Col>
              </Row>
            </CardBody>

    ...
    Items: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: `${process.env.PUBLIC_URL}/app/chat-app/chat-video-app`,
            type: "link",
            title: "Video-app",
          },
        ],
...

  {
    ...
    Items: [
      ...
      },
      {
        ...
        children: [
          {
            path: `${process.env.PUBLIC_URL}/app/learning/learninglist`,
            title: "LearningList",
            type: "link",
          },
          {
            path: `${process.env.PUBLIC_URL}/app/learning/learningdetail`,
